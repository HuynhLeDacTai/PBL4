...
public class panel_Content_Input_Path extends JPanel {
	...
	public void initcomponent() {
		...
		txtTimeOut.setBounds(333, 43, 100, 27);
		txtTimeOut.setForeground(Color.WHITE);
		panelContent.add(txtTimeOut);
		txtTimeOut.setBackground(new Color(69, 73, 74));
		txtTimeOut.setColumns(10);

		JButton btnOK = new JButton("OK");
		btnOK.setBounds(650, 18, 95, 40);
